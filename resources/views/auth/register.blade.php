                ...
                <form class="form" method="post" action="{{ route('register') }}">
                    ...
                    <div class="card-body">
                        <div class="input-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                            ...
                            <input type="text" name="name" class="form-control{{ $errors->has('username') ? ' is-invalid' : '' }}" placeholder="{{ __('Name') }}">
                        ...
                        <div class="input-group{{ $errors->has('username') ? ' has-danger' : '' }}">
                            ...
                            <input type="email" name="email" class="form-control{{ $errors->has('username') ? ' is-invalid' : '' }}" placeholder="{{ __('Username') }}">
                            @include('alerts.feedback', ['field' => 'username'])
                        </div>
